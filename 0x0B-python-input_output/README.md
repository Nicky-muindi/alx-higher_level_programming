...
* [tests](./tests): Folder of test files. Provided by Alx Engineering through The Room
...
| `7-add_item.py` | `use prototypes in 5,6` |
...
* **2. Append to a file**
  * [2-append_write.py](./2-append_write.py): Python function that prints `n` lines of a UTF8 text
  file to standard output.

* **3. To JSON string**
  * [3-to_json_string.py](./3-to_json_string.py): Python function returns the JSON representation of an object (string):

* **4. From JSON string to Object**
  * [4-from_json_string.py](./4-from_json_string.py): Python function that appends a string to the end of a
...
You t need to manage exceptions if the object can't be serialized.
