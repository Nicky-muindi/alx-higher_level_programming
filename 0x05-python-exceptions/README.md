...
In this project, I learned handling errors and exceptions in Python with `tr    y`
and `except`.

## Tests

* [tests](./tests): Folder of test files. Provided by Alx software Engineering through the Room 
...
* **9. ByteCode -> Python #4**
  * [102-magic_calculation.py](./102-magic_calculation.py): Python function matching exactly a
  bytecode provided by Alx software Engineering through the Room 
